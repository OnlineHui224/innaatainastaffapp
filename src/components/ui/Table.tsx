...
export function TableFrame({
  ...
  return (
    <div className={cn('overflow-hidden rounded-lg border border-slate-300 bg-white', className)}>
...
export function TH({ children, className, align = 'left', numeric, ...rest }: THProps) {
  return (
    <th
      scope="col"
      className={cn(
        'whitespace-nowrap px-3 py-2.5 text-2xs font-bold uppercase tracking-wide text-slate-600',
    ...
    >
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          disabled={page <= 1}
          className="h-9 rounded-md border border-slate-300 bg-white px-3 text-xs font-semibold text-slate-700 transition-colors hover:bg-slate-50 disabled:opacity-40"
        >
          Previous
        </button>
